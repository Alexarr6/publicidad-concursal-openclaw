...
class BrowserUseRunner:
    ...
    def run(self, target_url: str, run_date: date, download_dir: Path, timeout_ms: int) -> Path:
        ...
        try:
            ...
            raise RuntimeError("browser-use fallback interno requiere playwright instalado") from exc
    ...
    def _run_ui_flow(self, page: object, date_candidates: list[str], timeout_ms: int) -> None:
